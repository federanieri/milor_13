odoo.define('syd_commercial_return.QtyAtDateWidgetReturn', function (require) {
"use strict";
...
var QtyAtDateWidgetReturn = Widget.extend({
...
widget_registry.add('qty_at_date_widget_return', QtyAtDateWidgetReturn);

return QtyAtDateWidgetReturn;
});
