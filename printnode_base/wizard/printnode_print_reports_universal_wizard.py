...
class PrintnodePrintReportsUniversalWizard(models.TransientModel):
    ...
    record_line_ids = fields.One2many(
        comodel_name='printnode.print.reports.universal.wizard.lines',
    ...
    def _get_record_line_ids(self):
        ...
        record_line_ids = self.env['printnode.print.reports.universal.wizard.lines'].create(
            lines_vals)
...
class PrintnodePrintReportsUniversalWizardLine(models.TransientModel):
    _name = 'printnode.print.reports.universal.wizard.lines'
