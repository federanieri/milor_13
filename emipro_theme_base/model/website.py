...
class Website(models.Model):
    ...
    def get_brand(self, products=False):
        ...
        if products:
            ...
            shop_brands = products.mapped('product_brand_ept_id').filtered(lambda r: (r.website_published and (r.website_id.id and r.website_id.id in (False, self.get_current_website().id) or not r.website_id)))
        else:
