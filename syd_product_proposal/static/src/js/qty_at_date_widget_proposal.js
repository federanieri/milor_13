odoo.define('syd_product_proposal.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidget = Widget.extend({
    ...
    _setPopOver: function () {
        ...
        this.data.product_uom_qty = this.data.qty_proposed;
...
widget_registry.add('qty_at_date_widget_proposal', QtyAtDateWidget);
